...
PONYMAIL_PLUGIN_VERSION = 'd39d15d' # Must use single quotes
...
class Server(plugins.server.BaseServer):
    ...
    def __init__(self, args: argparse.Namespace):
        print(
            "==== Apache Pony Mail (Foal v/%s ~%s) starting... ====" % (PONYMAIL_FOAL_VERSION, PONYMAIL_PLUGIN_VERSION)
        )
        # Load configuration
    ...
    async def handle_request(
        ...
        headers = {
            "Server": "Apache Pony Mail (Foal/%s ~%s)" % (PONYMAIL_FOAL_VERSION, PONYMAIL_PLUGIN_VERSION),
        }
